...
type LBMap interface {
	...
	DumpAffinityMatches() (map[uint16]map[uint16]struct{}, error)
}
...
// deleteOrphanAffinityMatchesLocked removes affinity matches which point to no
// longer existing svc ID and backend ID tuples.
...
// TODO(brb) probably return error
